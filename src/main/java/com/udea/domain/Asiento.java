...
public class Asiento implements Serializable {
    ...
    public void setReservases(Set<Reserva> reservas) {
        if (this.reservases != null) {
            this.reservases.forEach(i -> i.setAsiento(null));
        }
        if (reservas != null) {
    ...
    public Asiento reservases(Set<Reserva> reservas) {
        this.setReservases(reservas);
        return this;
    }

    public Asiento addReservas(Reserva reserva) {
        this.reservases.add(reserva);
        reserva.setAsiento(this);
        return this;
    }

    public Asiento removeReservas(Reserva reserva) {
